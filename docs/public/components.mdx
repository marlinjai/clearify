...
summary: Reference and live examples for all built-in MDX components in Clearify, including Callout, Tabs, Steps, Cards, CodeGroup, Mermaid diagrams, StatusBadge, ProjectCard, and ProjectGrid.
category: documentation
tags: [clearify, mdx, components, reference]
status: active
date: 2026-02-08
order: 2
---
